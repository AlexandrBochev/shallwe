...
function MobileNavbar({ username }: MobileNavbarProps) {
    ...
    <div className="flex md:hidden items-center space-x-2">
      ...
      <Sheet open={showMobileMenu} onOpenChange={setShowMobileMenu}>
        ...
        <SheetContent side="right" className="w-[300px]">
          <SheetHeader>
            <SheetTitle>{MAIN_LAYOUT.NAVBAR.menu}</SheetTitle>
          </SheetHeader>
            ...
            {isSignedIn ? (
              <>
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href={`${MAIN_LAYOUT.NAVBAR.profile.href}/${username}`}>
